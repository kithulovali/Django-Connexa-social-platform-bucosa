...
urlpatterns = [
    ...
    path('staff_messages/fellowship/', views.staff_messages_fellowship, name='staff_messages_fellowship'),
    path('staff_messages/government/', views.staff_messages_government, name='staff_messages_government'),
